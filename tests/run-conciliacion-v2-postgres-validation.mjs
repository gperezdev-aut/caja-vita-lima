...
const migration043 = resolve(root, "sql/043_convenio_whatsapp_preconfirmado.sql");
const contract043 = resolve(root, "sql/tests/043_convenio_whatsapp_preconfirmado_rollback.sql");

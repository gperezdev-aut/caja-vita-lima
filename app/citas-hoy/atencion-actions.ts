...
function errorAmigable(error: string) {
  const pairs: Array<[string, string]> = [
    ...
    ["CONVENIO_NO_PERTENECE_A_RESERVA", "Ese convenio pertenece a otra reserva y no puede aplicarse a esta atención."],
    ["CONVENIO_YA_CANJEADO", "Ese convenio ya fue aplicado a una atención y no puede volver a usarse."],
    ["CONVENIO_SEDE_NO_COINCIDE", "El convenio fue registrado para otra sede. Revisa el registro antes de continuar."],

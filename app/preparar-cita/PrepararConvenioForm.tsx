...
export function PrepararConvenioForm({ sedes, requestId, minDate, onBack }: Props) {
  ...
  function next() {
    if (step === 0 && !canal) {
      setError("Selecciona Cuponidad o Bee Beneficios.");
      return;
    }
    ...
    <form action={formAction} className="atencionForm fichaPrepararForm prepararWizard" noValidate>
      ...
      {step === 0 && (
        <section className="wizardPanel visible prepararStepPanel">
          ...
          <h2>¿Qué proveedor es?</h2>
          <p className="wizardIntro">
            El proveedor quedará definido desde Caja. El cliente escribirá su propio código en la ficha web.
          </p>
      ...
      {step === 1 && (
        <section className="wizardPanel visible prepararStepPanel">
          ...
          <p className="wizardIntro">
            Solo selecciona sede, fecha y hora. El cliente completará sus datos y código desde la ficha.
          </p>
      ...
      {step === 2 && (
        <section className="wizardPanel visible prepararStepPanel">
          ...
          <div className="formMessage" style={{ marginTop: 16 }}>
            Caja agenda. El cliente completa nombre, WhatsApp, salud y código en la ficha pública de Vita Lima.
          </div>
        </section>
      )}
